...
try {
    ...
    // 2. Fetch Performance Stats (Total Orders & Total Revenue generated by this staff)
    $stmtStats = $pdo->prepare("
        ...
        WHERE user_id = ?
    ");
    $stmtStats->execute([$staff_id]);
    $stats = $stmtStats->fetch();

    // 3. Fetch Recent Orders handled by this staff
...
<main class="main-wrapper">
    <div class="admin-container">
        ...
        <div class="page-header">
            <h1>Staff Profile: <?php echo htmlspecialchars($staff['username']); ?></h1>
        </div>
        ...
        <div class="staff-detail-grid">
            ...
            <div class="profile-card">
                ...
                <span class="role-badge role-<?php echo $staff['role']; ?>"><?php echo ucfirst($staff['role']); ?></span>
                
                <div class="profile-info-list">
                    <div class="info-row">
                        <span>Email:</span>
                        <strong><?php echo htmlspecialchars($staff['email']); ?></strong>
                    </div>
                    <div class="info-row">
                        <span>Joined:</span>
                        <strong><?php echo date("d M Y", strtotime($staff['created_at'])); ?></strong>
                    </div>
                    <div class="info-row">
                        <span>User ID:</span>
